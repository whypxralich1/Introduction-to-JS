...
function setup() {
    ...
    // кнопка "громкость" с обработчиками событий
...
function draw() {
    ...
    if (isInitialised && !sound.isPlaying())
        ...
        fill(144, 242, 141);
        ellipse(width / 4, height / 2 - 35, 50 + energy);
        fill(144, 242, 141, 75);
        ellipse(width / 4, height / 2 - 35, 60 + energy);
        fill(144, 242, 141, 50); 
        ellipse(width / 4, height / 2 - 35, 70 + energy);
        fill(144, 242, 141, 25); 
        ellipse(width / 4, height / 2 - 35, 80 + energy);
        
        let high_energy = fft.getEnergy("highMid"); // круг слева
        fill(144, 242, 141);
        ellipse(width * 3 / 4, height / 2 - 35, 50 + high_energy);
        fill(144, 242, 141, 75);
        ellipse(width * 3 / 4, height / 2 - 35, 60 + high_energy);
        fill(144, 242, 141, 50);
        ellipse(width * 3 / 4, height / 2 - 35, 70 + high_energy);
        fill(144, 242, 141, 25);
        ellipse(width * 3 / 4, height / 2 - 35, 80 + high_energy);
        ...
        line(width / 2, height / 2, width / 2 + xOffset, height / 2 + yOffset);
        ...
        fill(255);
        textSize(24);
        text(currentTrackName, width / 2 - 330, height / 2 + 235); // название песни
    }
